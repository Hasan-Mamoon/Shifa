...
//     if (!slotTime || !availableDates[slotIndex]) {
...
//       doctorId: docId,
//       patientId: "PATIENT_ID", // Replace with actual patient ID (e.g., from user context)
//       slotId: "SLOT_ID", // Replace with the actual slot ID from the backend
